...
This repo does not reproduce the OFL license text here — see the link
above for it.

`NotoSansCJKjp-Regular.otf` — Noto Sans CJK JP, by Google, licensed under
the SIL Open Font License 1.1. Used for Japanese/CJK glyph generation and
rendering (e.g. the Japanese wordmark and CJK script support).
